    ...
    <div class="min-h-screen bg-page-bg flex justify-center py-8 px-4 text-text-primary">
      <div class="max-w-3xl w-full [&>p]:text-lg [&>p]:leading-relaxed [&>p]:mb-8">
        <header class="flex justify-between items-center pb-4 border-b border-border-color mb-8">
          ...
          <div class="text-text-secondary">2025-03-25</div>
        </header>

        <h1 class="text-4xl md:text-5xl mb-6 text-text-primary">
          This is a title for a post
        </h1>

        <p>Here's some text, lorem ipsum blah blah blah.</p>

        <p>
          According to all known laws of aviation, there is no way a bee should
          be able to fly. Its wings are simply too small to lift its fat little
          body off of the ground. The bee, of course, flies anyway, because bees
