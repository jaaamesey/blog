...
import {UseEffectBad} from './use_effect_bad.react.jsx';
import DemoWrapper from '~/utils/DemoWrapper.astro';

<DemoWrapper>
<UseEffectBad client:load />
</DemoWrapper>
...
But other frameworks are arguably stricter and more opaque about this. Svelte's [`$effect`](https://svelte.dev/docs/svelte/$effect) for example doesn't even ask for a dependency array, it just automatically listens to *everything it sees* in the effect function. 
