...
<DemoWrapper>
<EmbedReactComponent client:only="solid" name="BadTodoApp1" />
</DemoWrapper>
...
<DemoWrapper>
<EmbedReactComponent client:only="solid" name="BadTodoAppWithKey" demoProps={{enableDrawing: false}} />
</DemoWrapper>
...
<DemoWrapper>
<EmbedReactComponent client:only="solid" name="BadTodoAppWithKey" demoProps={{enableDrawing: true}} />
</DemoWrapper>
...
<DemoWrapper>
<EmbedReactComponent client:only="solid" name="BadTodoAppWithDeps" demoProps={{enableDrawing: true}} />
</DemoWrapper>
