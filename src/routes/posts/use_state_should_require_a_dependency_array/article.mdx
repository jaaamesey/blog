...
Maybe I should have chosen something that sounds less blasphemous for my first article. Oh well.

There's a few points I'd like to argue here.

My first, and hopefully least controversial point, is that **code like this should throw a lint error**:
