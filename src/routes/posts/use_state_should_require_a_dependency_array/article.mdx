...
import {BadTodoApp1, BadTodoAppWithKey, BadTodoAppWithDeps, BadTodoAppWithUseEffect} from './react_bad.react.jsx'

<DemoWrapper>
<BadTodoApp1 client:load/>
</DemoWrapper>
...
<DemoWrapper>
<BadTodoAppWithKey client:load enableDrawing={false}/>
</DemoWrapper>
...
<DemoWrapper>
<BadTodoAppWithKey client:load enableDrawing={true}/>
</DemoWrapper>
...
<DemoWrapper>
<BadTodoAppWithDeps client:load enableDrawing={true}/>
</DemoWrapper>
